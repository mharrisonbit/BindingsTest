...
typedef NS_ENUM(NSInteger, VMEViewMode)
{
     ...
     * - The camera focuses on the outside footprint.  
     * - If present, building models are made visible and building icons will 
     * appear.  
     * - All floors from all buildings will be made invisible.
     *
     * @version 1.0
     */
    VMEViewModeGlobal,
