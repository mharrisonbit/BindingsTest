 ...
 * performance. Where possible, favour the use of VMEPlaceInterface::addPlaceID:imageURL:data:position:
 * and VMEPlaceInterface::addPlaceID:imageURL:data:position:size:anchorMode:altitudeMode:displayMode:orientation:visibilityRamp:
 *
 @code
